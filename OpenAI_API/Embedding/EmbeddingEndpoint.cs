...
namespace OpenAI_API.Embedding
{
	...
	public class EmbeddingEndpoint : EndpointBase, IEmbeddingEndpoint
	{
		...
		/// </summary>
		public EmbeddingRequest DefaultEmbeddingRequestArgs { get; set; } = new EmbeddingRequest() { Model = Models.Model.AdaTextEmbedding };
        ...
        /// <summary>
        /// Ask the API to embedd text using the default embedding model <see cref="Models.Model.AdaTextEmbedding"/>
        /// </summary>
