...
{
    public interface IFineTuneEndpoint
    {
        /// <summary>
        ...
        Task<FineTuneResult> RetrieveFineTune(string Id);
        Task<FineTuneResultList> RetrieveFineTuneList();
        Task<FineTuneResult> CancelFineTune(string Id);
    }
